...
RUN npm config set @operations-innovations:registry=https://npm.pkg.github.com/ @architecture-it:registry=https://npm.pkg.github.com/ @witwot-jms:registry=https://npm.pkg.github.com/ @customer-experience:registry=https://npm.pkg.github.com/ //npm.pkg.github.com/:_authToken=${NPM_TOKEN}
